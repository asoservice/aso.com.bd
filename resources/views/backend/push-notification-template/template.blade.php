...
<div class="row">
    <div class="m-auto col-12-8">
        <div class="card tab2-card">
            ...
            <div class="button-container mb-3 pb-0">
                ...
                <!-- <div class="shortcode-list d-flex align-items-center gap-3">
                    

                   @forelse ($eventAndShortcodes["shortcodes"] as $key => $shortcode)
                            <div class="shortcode-item d-flex align-items-center">
                                <span class="shortcode-text">{{ $shortcode['text'] }}</span>
                                <span class="ms-2 add-shortcode" data-text="{{ $shortcode['action'] }}">
            ...
            <div class="card-body pt-0">
                <ul class="nav nav-tabs nav-material" id="account" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if ($loop->first) active show @endif" id="tab-{{ $language['locale'] }}-tab"
                            data-bs-toggle="tab" href="#tab-{{ $language['locale'] }}" role="tab"
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea class="form-control"
                                                            placeholder="{{ __('static.push_notification_templates.enter_content') }}"
                                                            rows="4" id="content_{{ $language['locale'] }}"
                                                            name="content[{{ $language['locale'] }}]"
                                                            cols="50">{{ @$content['content'][$language['locale']] }}</textarea>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-2 mb-2" for="url">
                                                        {{ __('static.push_notification_templates.url') }}
                                                    </label>
                                                    <div class="col-md-10">
                                                        <input class="form-control" id="url_{{ $language['locale'] }}"
                                                            type="url"
                                                            placeholder="{{ __('static.push_notification_templates.enter_url') }}"
