...
@hasrole('admin')
    ...
    <div class="col-md-10 error-div select-dropdown">
        <select class="select-2 form-control user-dropdown" id="provider_id" name="provider_id" data-placeholder="{{ __('static.service.select_provider') }}">
...
<div class='form-group row'>
    <label class="col-md-2" for="service_id">{{ __('static.service_package.services') }}
        <span> *</span> </label>
    <div class="col-md-10 error-div select-dropdown">
        <select id="services" class="select-2 form-control user-dropdown" search="true" name="service_id[]"
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(id, optionData) {
                            ...
                            if (selectedServices && selectedServices.includes(String(optionData.id))) {
