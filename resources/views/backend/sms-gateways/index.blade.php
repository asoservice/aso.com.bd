...
<div class="row g-sm-4 g-3">
    ...
    <div class="col-md-6">
        <div class="card tab2-card">
            <div class="card-header">
                ...
                <div class="status-div">
                    ...
                    <div class="editor-space">
                        <label class="switch">
                            <input class="form-check-input" type="checkbox" name="status" id="" value="1" @checked($smsGateway['status']) onchange="smsStatus('{{ $smsGateway['slug'] }}', this.checked)">
            ...
            <div class="card-body">
                <form action="{{route('backend.smsgateways.update', $smsGateway['slug'])}}" id="" method="POST">
                    @csrf
                    @method("POST")
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xxl-8">
                            ...
                            <textarea class="form-control" name="{{ $fieldKey }}" id="{{ $fieldKey }}" placeholder="{{ $field['label'] }}">{{  Helpers::encryptKey($fieldValue) }}</textarea>
