        ...
        <div class="card-header d-flex align-items-center">
            ...
            @can('backend.testimonial.create')
                <div class="btn-popup ms-auto mb-0">
                    <a href="{{ route('backend.testimonial.create') }}" class="btn">{{ __('static.testimonials.create') }}
                    </a>
                </div>
            @endcan
            @can('backend.testimonial.destroy')
            <a href="javascript:void(0);" class="btn btn-sm btn-secondary deleteConfirmationBtn"  style="display: none;" data-url="{{ route('backend.delete.testimonials') }}">
