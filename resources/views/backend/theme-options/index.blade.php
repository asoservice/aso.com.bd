                ...
                <div class="col-xxl-3 col-xl-4 col-12">
                    <div class="nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link active" id="v-pills-tabContent" data-bs-toggle="pill"
                            ...
                            {{ __('static.theme_options.general') }}
                        </a>
                        ...
                        <a class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill"
                            href="#contact_us_option">
                            <i class="ri-contacts-line"></i>{{ __('static.theme_options.contact_us') }}
                        </a>
                        <a class="nav-link" id="v-pills-pagination-tab" data-bs-toggle="pill"
                            href="#pagination_option">
                            <i class="ri-stack-fill"></i>{{ __('static.theme_options.paginations') }}
                        </a>
                        <a class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill"
                            href="#about_us_option">
                ...
                <div class="col-xxl-7 col-xl-8 col-12">
                    <form method="POST" class="needs-validation user-add h-100" id="themeOptionForm"
                        ...
                        <div class="tab-content w-100" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="general_option" role="tabpanel"
                                aria-labelledby="general_option" tabindex="0">
                                <div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="file" id="general[header_logo]"
                                                accept=".jpg, .png, .jpeg" name="general[header_logo]">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="file" id="general[favicon_icon]"
                                                accept=".jpg, .png, .jpeg" name="general[favicon_icon]">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="file" id="general[footer_logo]"
                                                accept=".jpg, .png, .jpeg" name="general[footer_logo]">
                                    ...
                                    <div class="form-group row">
                                        <label for="breadcrumb_description" class="col-md-2">{{ __('Breadcrumb Description') }}</label>
                                        <div class="col-md-10">
                                            <textarea class="form-control" name="general[breadcrumb_description]" id="general[breadcrumb_description]" placeholder="{{ __('static.theme_options.enter_description') }}" rows="2">{{ $themeOptions['general']['breadcrumb_description'] ?? old('general[breadcrumb_description]') }}</textarea>
                            ...
                            <div class="tab-pane fade" id="header_option" role="tabpanel"
                            ...
                            <div class="tab-pane fade" id="footer_option" role="tabpanel"
                            ...
                            <div class="tab-pane fade" id="contact_us_option" role="tabpanel"
                            ...
                            <div class="tab-pane fade" id="pagination_option" role="tabpanel"
                                aria-labelledby="v-pills-pagination-tab" tabindex="4">
                                <div class="form-group row">
                                    <label class="col-md-2"
                            ...
                            <div class="tab-pane fade tab2-card" id="about_us_option">
                                <ul class="nav mb-3 nav-tabs" id="pills-tab">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="about_tab" data-bs-toggle="pill" href="#about">About</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="work_tab" data-bs-toggle="pill" href="#work">Work Banner</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="provider_tab" data-bs-toggle="pill" href="#provider">Providers List</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="user_tab" data-bs-toggle="pill" href="#user">Testimonial</a>
                                    </li>
                            ...
                            <div class="tab-pane fade theme-option-tab-box tab2-card" id="page" role="tabpanel"
                                aria-labelledby="page" tabindex="6">
                                <ul class="nav mb-3 nav-tabs" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="terms_and_conditions_tab" data-bs-toggle="pill" href="#terms_and_conditions">Terms & Conditions</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="privacy_policy_tab" data-bs-toggle="pill" href="#privacy_policy">Privacy Policy</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="terms_and_conditions" role="tabpanel" aria-labelledby="terms_and_conditions_tab">

                                        <div class="accordion theme-accordion" id="terms_and_conditions_BannersAccordion">
                                        ...
                                        <button type="button" id="add_terms_and_conditions_Banner" class="btn btn-primary mt-3">Add
                                            Banner</button>
                                    ...
                                    <div class="tab-pane fade" id="privacy_policy" role="tabpanel" aria-labelledby="privacy_policy_tab">
                                        ...
                                        <button type="button" id="add_privacy_policy_Banner" class="btn btn-primary mt-3">Add
                                            Banner</button>
                            ...
                            <div class="tab-pane fade" id="authentication" role="tabpanel" aria-labelledby="authentication" tabindex="7">
                                <div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="file"
                                                id="authentication[header_logo]"
                                                name="authentication[header_logo]">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="file"
                                                id="authentication[auth_images]"
                                                name="authentication[auth_images]">
                            ...
                            <div class="tab-pane fade" id="seoSection" role="tabpanel"
                                aria-labelledby="general_option" tabindex="0">
                                <div>
                                    <div class="form-group row">
                                        <label for="image"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea class="form-control" name="seo[og_description]" id="seo[og_description]" placeholder="{{ __('static.theme_options.enter_description') }}" rows="4">{{ $themeOptions['seo']['og_description'] ?? old('seo[og_description]') }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        <label for="meta_description" class="col-md-2">{{ __('Meta Descriptions') }}</label>
                                        <div class="col-md-10">
                                            <textarea class="form-control" name="seo[meta_description]" id="seo[meta_description]" placeholder="{{ __('static.theme_options.enter_description') }}" rows="4">{{ $themeOptions['seo']['meta_description'] ?? old('seo[meta_description]') }}</textarea>
...
<script>
    ...
    let termsBannerIndex = {{ count($themeOptions['terms_and_conditions']['banners'] ?? []) }}; // Existing banners count
    ...
    $('#add_terms_and_conditions_Banner').click(function() {
        const template = $('#terms_and_conditions_bannerTemplate').html().replace(/__INDEX__/g, termsBannerIndex); // Replace __INDEX__ with termsBannerIndex
        $('#terms_and_conditions_BannersAccordion').append(template); // Append the new banner template
