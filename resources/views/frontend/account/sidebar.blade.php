                        ...
                        <ul class="nav nav-tabs menu-wrapper">
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('account/profile*') ? 'active' : '' }}"
                                    ...
                                    <img src="{{ asset('frontend/images/svg/home-1.svg') }}" class="active-icon"
                                        alt="home">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('account/notification*') ? 'active' : '' }}"
                                    ...
                                    <img src="{{ asset('frontend/images/svg/notification.svg') }}" class="active-icon"
                                        alt="notification">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('account/wallet*') ? 'active' : '' }}"
                                    ...
                                    <img src="{{ asset('frontend/images/svg/wallet-3.svg') }}" class="active-icon"
                                        alt="wallet">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('account/address*') ? 'active' : '' }}"
                                    ...
                                    <img src="{{ asset('frontend/images/svg/location.svg') }}" class="active-icon"
                                        alt="location">
            ...
            <form action="{{ route('frontend.account.profile.update') }}" method="POST" id="profileForm"
                ...
                <div class="modal-body">
                    ...
                    <div class="update-detail">
                        ...
                        <div class="form-group">
                            <label class="col-md-2" for="phone">{{ __('static.phone') }} <span
