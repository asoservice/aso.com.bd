                    ...
                    <div class="profile-main h-100">
                        <div class="card payment m-0">
                            <div class="card-header">
                                ...
                                <button type="button" class="edit-option" data-bs-toggle="modal"
                                        ...
                                        <div class="select-date">
                                            ...
                                            <div class="date-pick">
                                                ...
                                                <button id="filter-btn"
                                                    class="btn btn-primary">{{ __('frontend::static.account.filter') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
...
$(function() {
    ...
    $('#filter-btn').on('click', function() {
        ...
        if (!dateRange) {
            ...
            return; // Prevent filter from being applied
        }

        const [startDate, endDate] = $('#range-date').val().split(' to ');
        const url =
            `{{ route('frontend.account.wallet') }}?start_date=${startDate}&end_date=${endDate}`;
