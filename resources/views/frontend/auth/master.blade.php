        ...
        <div class="row login-content g-0">
            <div class="col-xl-6 d-xl-block d-none">
                <div class="image-contain">
                    <a href="{{ route('frontend.home') }}"><img src="{{ asset($themeOptions['authentication']['header_logo']) ?? '' }}" class="logo" alt=""></a>
                    <img src="{{ asset($themeOptions['authentication']['auth_images']) ?? '' }}" class="auth-image" alt="">
                    <div class="auth-content">
                        ...
                        <div class="app-install">
                            <a href="{{ ($themeOptions['general']['app_store_url']) }}" target="_blank" rel="noopener noreferrer">
                                <img src="{{ asset('frontend/images/app-store.png') }}" alt="app store">
                            </a>
                            <a href="{{ ($themeOptions['general']['google_play_store_url']) }}" target="_blank" rel="noopener noreferrer">
                        ...
                        <div class="dropdown language-dropdown">
                            <button id="languageSelected" class="language-btn">
                                ...
                                <span>
                                    ...
                                    @else
                                    <img src="{{ asset('admin/images/No-image-found.jpg') }}" alt="" class="img-fluid">
                                    @endif
                            ...
                            <ul class="onhover-show-div">
                                ...
                                <li class="lang">
                                    <a href="{{ route('lang', ['locale' => @$lang?->locale, 'locale_flag' => @$lang?->flag_path]) }}"
                                        data-lng="{{ @$lang?->locale }}"><img class="img-fluid lang-img" alt="{{$lang?->name}}" src="{{ @$lang?->flag ?? asset('admin/images/No-image-found.jpg') }}">{{ @$lang?->name }}
                                    </a>
                                </li>
                                @empty
                                <li class="lang">
