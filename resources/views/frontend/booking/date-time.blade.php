          ...
          <div class="row g-3">
            <div class="col-12">
              <div class="input-group main-inline-calender">
                <input class="form-control mb-2" id="inline-calender" type="date" name="date">
              </div>
            </div>
            <div class="col-12">
              <div class="inline-time-picker">
                <p class="mb-2">{{__('frontend::static.bookings.time')}}</p>
...
<!-- cancel reason modal -->
<div class="modal fade cancel-modal" id="cancelReasonModal-{{$booking?->id}}" tabindex="-1" aria-labelledby="cancelReasonModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
