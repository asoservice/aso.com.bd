                                                    ...
                                                    <div class="date-time-picket-sec">
                                                        <div class="select-option">
                                                            <div class="form-check mb-0">
                                                                <input type="radio" id="customTimeSlot01" value="custom" name="select_date_time"
                                                                    class="form-radio-input custom_date_time_1" checked>
                                                            ...
                                                            <div class="d-flex align-items-start gap-sm-3 gap-2">
                                                                <div class="form-check mb-0">
                                                                        <input type="radio" data-bs-toggle="modal" data-bs-target="#datetimeModal"  id="providerTimeSlot01" value="timeslot" name="select_date_time" class="form-radio-input custom_date_time_1">
                                    ...
                                    <div class="py-0 service-booking">
                                        <ul>
                                            ...
                                            <li class="d-flex align-items-start booking-list">
                                                ...
                                                <div class="booking-data">
                                                    <div
                                                        class="d-flex flex-sm-row flex-column align-items-sm-center align-items-start justify-content-between gap-1 mb-2">
                                                        <h3 class="mb-0">{{__('frontend::static.bookings.bill_summary')}}</h3>
                                                        @auth
                                                        <span class="text-success">{{__('frontend::static.bookings.wallet')}}
                                                            <small>
                                                                :
                                                                {{ Helpers::getDefaultCurrencySymbol() }}{{ auth()?->user()?->wallet?->balance }}
                                                            </small>
                                                        </span>
                                                        @endauth
                                                    </div>
