...
@isset($service)
<!-- Book Service Modal -->
<div class="modal fade book-service" id="bookServiceModal-{{ $service->id }}" tabindex="-1"
    aria-labelledby="bookServiceModalLabel-{{ $service->id }}" aria-hidden="true">
                    ...
                    <div>
                        ...
                        <div class="select-servicemen">
                            ...
                            <div class="plus-minus">
                                ...
                                <input id="quantityInput" name="required_servicemen" type="number"
                                    value="{{ $service->required_servicemen }}"
                    ...
                    <div>
                        ...
                        <div class="select-option">
                            <div class="form-check">
                                <input type="radio" id="optionone-{{ $service->id }}" name="select_serviceman" value="app_choose"
                                    class="form-radio-input" checked>
                                <label for="optionone-{{ $service->id }}">{{ __('frontend::static.modal.let_app_choose') }}</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" id="optiontwo-{{ $service->id }}" name="select_serviceman" value="as_per_my_choice"
                        ...
                        <div class="provider-content">
                            ...
                            <div class="view br-6 mt-3">
                                <div class="d-flex align-items-center justify-content-between gap-1">
                                    <span class="text-title">{{ __('frontend::static.modal.services_delivered') }}</span>
                                    <small class="value"> {{ $serviceman?->served }} {{ __('frontend::static.modal.served') }}</small>
                                </div>
                            </div>
                            <div class="information">
                                <div>
                                    <p class="mt-3 mb-2">{{ __('frontend::static.modal.personal_info') }}</p>
                                    <div class="profile-info">
                                        @if($serviceman?->email)
                                        <div>
                                            <label>
                                                <i class="iconsax" icon-name="mail"></i>
                                                {{ __('frontend::static.modal.mail') }}
                                            </label>
                                            <p>{{ $serviceman?->email }}</p>
                                        </div>
                                        @endif
                                        @if($serviceman?->phone && $serviceman?->code)
                                        <div>
                                            <label>
                                                <i class="iconsax" icon-name="phone"></i>
                                                {{ __('frontend::static.modal.call') }}
                                            </label>
                                            <p>+{{ $serviceman?->code }} {{ $serviceman?->phone }}</p>
                                        </div>
                                        @endif
                                    </div>
                                </div>
