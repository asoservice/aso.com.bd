        ...
        <div class="row gy-3 gy-md-4 gy-xl-0">
            <div class="col-xl-3 col-sm-6 col-12">
                <div class="nav d-block">
                    ...
                    <ul>
                        ...
                        @empty
                        <li><a class="nav-link" href="javascript:void(0)">{{ __('frontend::static.footer.no_link_found') }}</a></li>
                        @endforelse
                        @endif
                    </ul>
                </div>
            ...
            <div class="col-xl-3 col-sm-6 col-12">
                <div class="nav d-block">
                    ...
                    <ul>
                        ...
                        <li><a class="nav-link" href="{{ url( $page['slug'] ) }}">{{ $page['name'] }} </a></li>
                        @empty
                        <li><a class="nav-link" href="javascript:void(0)">{{ __('frontend::static.footer.pages_not_found') }}</a></li>
                        @endforelse
                        @endif
                    </ul>
                </div>
            ...
            <div class="col-xl-3 col-sm-6 col-12">
                <div class="nav d-block">
                    ...
                    <ul>
                        ...
                        @auth
                        <li><a class="nav-link" href="{{ url( $other['slug'] ) }}">{{ $other['name'] }} </a></li>
                        @endauth
                        @else
                        <li><a class="nav-link" href="{{ url( $other['slug'] ) }}">{{ $other['name'] }} </a></li>
                        @endif
                        @empty
                        <li><a class="nav-link" href="javascript:void(0)">{{ __('frontend::static.footer.others_not_found') }}</a></li>
                        @endforelse
                        @endif
                    </ul>
                </div>
            ...
            <div class="col-xl-3 col-sm-6 col-12">
                <div class="nav d-block">
                    ...
                    <a href="{{url('backend/become-provider')}}" class="btn btn-solid">{{ __('frontend::static.footer.register_now') }}
