...
<link rel="icon" href="{{ @$settings['general']['favicon'] ?? asset('admin/images/faviconIcon.png') }}"
    type="image/x-icon">

<link rel="shortcut icon" href="{{ @$settings['general']['favicon'] ?? asset('admin/images/faviconIcon.png') }}"
    type="image/x-icon">
