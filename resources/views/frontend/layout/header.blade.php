                                ...
                                <div id="locationBox" class="onhover-show-div">
                                    <div class="detect-location">
                                        <div class="detect-location-title">
                                            ...
                                            <a class="close-btn" id="locationCloseBtn"><i class="iconsax location-icon"
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="dropdown currency-dropdown nav-item-right d-xxl-flex d-none">
                                ...
                                <button id="unitSelected" class="currency-btn">
                                    <span>
                                        ...
                                        <img src="{{ Helpers::isFileExistsFromURL($defaultCurrencyImg, true) }}" alt="" class="img-fluid">
                                        @else
                                        <img src="{{ asset('admin/images/No-image-found.jpg') }}" alt=""
                                            class="img-fluid">
                                        @endif{{ $defaultCurrency?->code }}
                                    </span>
                                    <i lass="iconsax" icon-name="chevron-down"></i>
                                </button>
                                <ul class="onhover-show-div">
                                    ...
                                    <li class="currency">
                                        <a href="{{ route('set.currency', $currency?->code) }}">
                                            ...
                                            <img class="img-fluid" src="{{Helpers::isFileExistsFromURL($currencyImg, true) }}"
                                                alt="{{$currency?->code}}" />
                                            @else
                                            <img src="{{ asset('admin/images/No-image-found.jpg') }}" alt=""
                                                class="img-fluid">
                            ...
                            <li class="dropdown language-dropdown nav-item-right d-xxl-flex d-none">
                                <button id="languageSelected" class="language-btn">
                                    ...
                                    <span>
                                        ...
                                        <img src="{{ Helpers::isFileExistsFromURL($flag, true) }}" alt="{{$lang?->name}}" class="img-fluid">
                                        @else
                                        <img src="{{ asset('admin/images/No-image-found.jpg') }}" alt=""
                                            class="img-fluid">
                                        @endif
                                ...
                                <ul class="onhover-show-div">
                                    ...
                                    <li class="lang">
                                        <a href="{{ route('lang', ['locale' => @$lang?->locale, 'locale_flag' => @$lang?->flag_path]) }}"
                                            data-lng="{{ @$lang?->locale }}"><img class="img-fluid lang-img"
                                                alt="{{$lang?->name}}"
                                                src="{{ @$lang?->flag ?? asset('admin/images/No-image-found.jpg') }}">{{ @$lang?->name }}
                                        </a>
                                    </li>
                                    @empty
                                    <li class="lang">
                                        <a href="{{ route('lang', 'en') }}" data-lng="en"><img class="active-icon"
                                                src="{{ asset('admin/images/flags/LR.png') }}" alt="en"><a
                                                href="javascript:void(0)" data-lng="en">En</a>
                                    </li>
                                    @endforelse
                                </ul>
                            </li>
                            ...
                            <li class="login-btn nav-item-right">
                                <a href="{{ url('login') }}"
                                    ...
                                    <span>{{ __('frontend::static.header.now') }}</span></a>
                            </li>
                            @endauth
                        </ul>
                    </nav>
...
<div class="modal fade location-detected-modal" id="locationSelected" tabindex="-1" data-bs-backdrop="static"
    data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">{{ __('frontend::static.home_page.your_location') }}
                </h1>
            ...
            <div class="modal-body">
                ...
                <!-- Spinner HTML -->
                <div id="locationSpinner" class="spinner-border" style="display: none;">
...
(function($) {
    $('.currency').on('click', function() {
        ...
        $.ajax({
            ...
            type: "GET",
            success: function() {
                $('#unitSelected span').html($(this).html()); // Update selected currency button
