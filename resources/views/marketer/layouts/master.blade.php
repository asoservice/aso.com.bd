...
<body class="theme {{ session('dir', 'ltr') }} {{ session('theme', '') }}">
    ...
    <div class="page-wrapper">
        ...
        @includeIf('marketer.layouts.partials.header')

        <div class="page-body-wrapper">

            @includeIf('marketer.layouts.partials.sidebar')

            <div class="page-body">

                @includeIf('marketer.layouts.partials.breadcrumb')

                <div class="container-fluid">

                    @include('marketer.inc.alerts')
            ...
            @includeIf('marketer.layouts.partials.footer')

            @includeif('marketer.inc.files')
