        ...
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            <li>
                ...
                <ul class="sidebar-submenu {{ Request::is('affiliate/user*') || Request::is('affiliate/role*') ? 'menu-open' : '' }}">
                    <li>
                        <a href="#"
                            class="{{ Request::is('affiliate') && !Request::is('affiliate') ? 'active' : '' }}">{{ __('static.marketer.customer_affiliate') }}</a>
                    </li>
                    <li>
                        <a href="#"
                            class="{{ Request::is('affiliate') && !Request::is('affiliate') ? 'active' : '' }}">{{ __('static.marketer.provider_affiliate') }}</a>
                    </li>
                    <li>
                        <a href="#"
                            class="{{ Request::is('affiliate') && !Request::is('affiliate') ? 'active' : '' }}">{{ __('static.marketer.downline_marketer') }}</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul class="sidebar-submenu {{ Request::is('affiliate/user*') || Request::is('affiliate/role*') ? 'menu-open' : '' }}">
                    <li>
                        <a href="#"
                            class="{{ Request::is('affiliate') && !Request::is('affiliate') ? 'active' : '' }}">{{ __('static.marketer.order_comm_reports') }}</a>
                    </li>
                    <li>
                        <a href="#"
                            class="{{ Request::is('affiliate') && !Request::is('affiliate') ? 'active' : '' }}">{{ __('static.marketer.campaign_reports') }}</a>
                    </li>
                    <li>
                        <a href="#"
                            class="{{ Request::is('affiliate') && !Request::is('affiliate') ? 'active' : '' }}">{{ __('static.marketer.referrals_history') }}</a>
                    </li>
                </ul>
            </li>
            <li>
